...
.then(data => {
  ...
  {
    if(data[0][i].home_score>data[0][i].visitor_score)
    {
      data[0][i]["winner"] = "CU_BOULDER";
    }
    else
    {
      data[0][i]["winner"] = data[0][i].visitor_name;
    }
  }
  console.log(data[2]);
...
app.get('/player_info', function(req, res) {
  //var query0 = req.query.player_choice;
  var query1 = 'select * from football_players;';
  //var query2 = "select * from football_players where id = '" + query0 + "';";
  //var query3 = "select * from football_games where ' " + query0 + "';";
